// JavaScript Document
  function source(){  var source = 'ufrbmhwap';
        ...
        var App = function () {
            ...
            function setOverflowX(element) {
                element.parentNode.style.width = element.getBoundingClientRect().width + 'px'
            }
            function getElementsByClassName(str, root, tag) {
                ...
                if (root.getElementsByClassName) {
                    return root.getElementsByClassName(str)
                }

                if (root.querySelectorAll) {
                    return root.querySelectorAll('.' + str)
                }
        ...
        void function () {
            ...
            // 轮播
            var mainSwipe = Swipe(document.getElementById('mainSwipe'), {
                auto: 4000,
  ...
  function doClick(o){
	  o.className=" weui_navbar_item  weui_bar_item_on c_f8";
	 ...
	 for(var i=1;i<=3;i++){
	   ...
	   if(id!= o.id){
	   	 j.className="weui_navbar_item show c_99";
